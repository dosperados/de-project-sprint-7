...
def parquet_event(date: str, depth: int, sname: str, hdfs_path: str, geo_path: str): 
...
def main():
    ...
    parquet_event(date=date, depth=depth, sname=sname, hdfs_path=hdfs_path, geo_path=geo_path)
